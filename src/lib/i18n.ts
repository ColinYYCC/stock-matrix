...
export const messages = {
  zh: {
    heatmap: {
      ...
      hideUnreadableLabel: "无字色块",
      hideUnreadableDescription: "主视图上小到连一个字都放不下的色块会被剔除，位置让给有名字的色块。股票数据保留：拉大窗口或筛选板块后它们会重新出现。",
      hideUnreadableOn: "隐藏（默认）",
      hideUnreadableOff: "全部显示",
      labelSizeLabel: "色块文字大小",
      labelSizeDescription: "看不清小字就调大一档；字越大，能塞进色块的信息行数越少。",
      labelSizeCompact: "紧凑",
      labelSizeStandard: "标准",
      labelSizeRoomy: "大字（默认）",
      showPriceLabel: "色块显示价格",
      showPriceDescription: "关闭后色块只显示名称和涨跌幅，空间更宽松、文字更大。",
      showPriceOn: "显示价格",
      showPriceOff: "隐藏价格",
      helpTitle: "使用帮助",

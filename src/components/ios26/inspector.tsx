...
export const Inspector = forwardRef<HTMLDivElement, InspectorProps>(function Inspector(
  ...
  return (
    <aside
      className="pointer-events-none absolute z-30 overflow-hidden rounded-3xl border border-[var(--ios26-glass-border)] bg-[#0f1319] text-slate-100 shadow-[0_22px_72px_rgba(0,0,0,0.36)]"
      style={{
        left: style.left,
        top: style.top,
        width: style.width,
    ...
    >
      {stock && (
        <>
          {/* 个股信息头部：背景色跟随涨跌色模式 */}
          <div className="px-3 py-2.5" style={{ backgroundColor: getInspectorHeaderColor(priceColorMode) }}>
